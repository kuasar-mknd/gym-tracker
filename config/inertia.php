...
return [
    ...
    */
    ...
    'pages' => [
        ...
        /**
         * This app's pages live in js/Pages, capitalised. Inertia 3 lowered the
         * default to js/pages, which resolves anyway on a case-insensitive
         * filesystem — so the whole suite stayed green on macOS and every
         * assertInertia()->component() failed on CI with "Inertia page
         * component file [Dashboard] does not exist".
         *
         * tests/Feature/InertiaPagePathTest.php compares against the real
         * directory entry rather than asking is_dir(), which would answer yes
         * to either spelling here and no on Linux.
         */
        'paths' => [
