...
- Use `grepai search` for natural language code search.
- Use `grepai trace` to analyze call graphs.
- To execute a search, use the `run_command` tool with `grepai search <query>`.
