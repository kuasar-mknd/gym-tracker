...
return new class() extends Migration
{
    ...
    {
        // We do not drop the index in down() because it might be used by a foreign key
        // and it is also managed by other migrations (2026_01_27, 2026_02_02).
        // Attempting to drop it causes 1553 errors in CI environments.
    }
};
