...
return new class() extends Migration
{
    ...
    {
        // Empty down method to prevent MySQL Error 1553 (foreign key constraint) during automated rollback cycles in CI.
        // Try-catch blocks inside schema closures are ineffective against queued commands.
    }
};
