...
return new class() extends Migration
{
    ...
    {
        // Leaving empty to avoid MySQL Error 1553: Cannot drop index needed in a foreign key constraint.
        // During CI rollbacks, this index might be required by foreign keys.
        // It's safer to leave the index than to break the rollback.
    }
};
