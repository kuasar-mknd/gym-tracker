...
class StatsService
{
    ...
    /**
     * @return array<int, object{category: string, volume: int|float}>
     */
    ...
    {
        /** @var object{started_at: string, volume: float|int|string, name: string} $row */
    ...
    /**
     * @return \Illuminate\Support\Collection<string, object{date: string, volume: float}>
     */
    ...
    /**
     * @param \Illuminate\Support\Collection<string, object{date: string, volume: float}> $workouts
     * @return array<int, array{date: string, day_label: string, volume: float}>
     */
    protected function fillWeeklyTrend(Carbon $startOfWeek, \Illuminate\Support\Collection $workouts): array
    {
        ...
        for ($i = 0; $i < 7; $i++) {
            ...
            if (isset($workouts[$date])) {
                /** @var object{volume: float|int|string} $workoutData */
                $workoutData = $workouts[$date];
    ...
    {
        /** @var object{started_at: string, name: string, volume: float|int|string} $row */
    ...
    {
        /** @var object{started_at: string, epley_1rm: float|int|string} $set */
