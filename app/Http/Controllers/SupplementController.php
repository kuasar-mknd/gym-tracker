...
class SupplementController extends Controller
{
     ...
     *
     * @param  \Illuminate\Http\Request  $request  The incoming HTTP request containing supplement details.
     ...
     *
     * @param  \Illuminate\Http\Request  $request  The incoming HTTP request with updated details.
