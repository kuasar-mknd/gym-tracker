...
<head>
    ...
    <link
        href="data:image/x-icon;base64,"
        rel="icon" type="image/x-icon">

    {!! Pulse::css() !!}
    @livewireStyles

    {!! str_replace('<script>', '<script nonce="' . csp_nonce() . '">', Pulse::js()) !!}
    {{-- @livewireScriptConfig doesn't support nonce injection easily via blade directive, but it should output script tag --}}
    {{-- We have to manually reconstruct what livewireScriptConfig does OR use valid nonce --}}
    {{-- Actually, if we use Livewire::getScriptConfig() we can wrap it --}}
    <script nonce="{{ csp_nonce() }}">
        window.livewireScriptConfig = {
            csrf: '{{ csrf_token() }}',
            uri: '{{ app()->getLocale() }}/livewire/update',
            progressBar: '',
            nonce: '{{ csp_nonce() }}' // Livewire 3 supports this?
        };
    </script>
    {{-- Pulse relies on @livewireScriptConfig to init? The directive usually outputs `window.livewireScriptConfig = ...` --}}
    {{-- Let's check if strictly replacing the directive works better or if we need to call the directive and replace. --}}
    {{-- Directives in Blade are compiled. We can't wrap a directive in str_replace easily in Blade. --}}
    {{-- But we can use PHP to capture it? No, simpler: --}}

    {{-- Livewire 3: --}}
    @php
        $livewireConfig = \Livewire\Mechanisms\FrontendAssets\FrontendAssets::scriptConfig();
    @endphp
    {!! str_replace('<script>', '<script nonce="' . csp_nonce() . '">', $livewireConfig) !!}
...
<body class="bg-gray-50 dark:bg-gray-950 font-sans antialiased">
    <div class="min-h-screen">
        <header class="px-5">
            <div
                class="{{ $fullWidth ? '' : 'container' }} py-3 sm:py-5 mx-auto border-b border-gray-200 dark:border-gray-900">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <span class="ml-2 text-lg sm:text-2xl text-gray-700 dark:text-gray-300 font-medium"><b
                                class="font-bold">Laravel</b> Pulse</span>
                    </div>
        ...
        <main class="pt-6 px-6 pb-12">
            <div
                {{ $attributes->merge(['class' => "mx-auto grid default:grid-cols-{$cols} default:gap-6" . ($fullWidth ? '' : ' container')]) }}>
                {{ $slot }}
            </div>
        </main>
    </div>
