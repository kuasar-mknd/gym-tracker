    ...
    <div class="w-full">
        ...
        <div class="relative">
            ...
            <button
                ...
                class="text-text-muted hover:text-text-main focus-visible:ring-electric-orange absolute top-1/2 right-3 -translate-y-1/2 rounded-full p-1 transition-all focus-visible:ring-2 focus-visible:outline-none"
