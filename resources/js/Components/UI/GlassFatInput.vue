        ...
        >
            ...
            >
                <button
                    v-press="{ haptic: 'tap' }"
                    type="button"
                    class="text-text-main focus-visible:ring-electric-orange flex h-10 w-10 items-center justify-center rounded-2xl border border-slate-200 bg-white/60 text-2xl font-bold shadow-sm backdrop-blur-md transition-all hover:-translate-y-1 hover:bg-white/80 focus-visible:ring-2 focus-visible:outline-none active:scale-95 dark:border-slate-700 dark:bg-slate-800/50 dark:hover:bg-slate-700"
