...
<template>
    <button
        ...
        class="text-text-main border-border focus-visible:ring-accent-primary h-11 shrink-0 rounded-xl border-2 px-2 text-center font-bold tabular-nums focus-visible:ring-2 focus-visible:outline-none disabled:opacity-60"
