            ...
            <div class="p-4">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex gap-2">
                        ...
                        <button
                            @click="toggleTimer"
                            class="bg-accent-primary flex h-10 w-10 items-center justify-center rounded-full text-black transition hover:brightness-110 active:scale-95 shadow-lg shadow-orange-500/20"
                        >
