                ...
                >
                    <div class="flex flex-col items-center space-y-4 text-center">
                        <div class="rounded-full bg-emerald-500/20 p-4 text-emerald-500">
                            <span class="material-symbols-outlined text-3xl" aria-hidden="true">local_fire_department</span>
                        </div>
            ...
            <Link :href="route('tools.water.index')" class="group">
                ...
                >
                    <div class="flex flex-col items-center space-y-4 text-center">
                        ...
                        <h3 class="text-xl font-bold text-text-main">Suivi Hydratation</h3>
                        <p class="text-sm text-text-muted">Suis ta consommation d'eau quotidienne et reste hydraté.</p>
                    </div>
                </GlassCard>
            </Link>
        </div>
