<template>
    <AuthenticatedLayout page-title="Outils" show-back back-route="profile.index">
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <!-- Sleep Tracker -->
            <Link :href="route('tools.sleep.index')" class="group">
                <GlassCard
                    class="relative h-full overflow-hidden p-6 transition-all duration-300 group-hover:bg-white/10"
                >
                    <div class="flex flex-col items-center space-y-4 text-center">
                        ...
                        <h3 class="text-xl font-bold text-text-main">Sleep Tracker</h3>
                        <p class="text-sm text-text-muted">Monitor your sleep quality and duration for better recovery.</p>
                    </div>
                </GlassCard>
            </Link>
        </div>
