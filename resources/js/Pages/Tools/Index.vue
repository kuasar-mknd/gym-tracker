    ...
    <AuthenticatedLayout page-title="Outils" show-back back-route="profile.index">
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Link :href="route('plates.index')" class="group block" v-press>
                <GlassCard
                    class="relative h-full overflow-hidden rounded-3xl border border-white/20 bg-white/10 p-6 backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:bg-white/20 hover:shadow-lg active:scale-95"
                >
