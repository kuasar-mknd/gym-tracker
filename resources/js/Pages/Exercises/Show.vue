...
const ExerciseMaxWeightChart = defineAsyncComponent(() => import('@/Components/Stats/ExerciseMaxWeightChart.vue'))
    ...
    <AuthenticatedLayout :page-title="exercise.name" show-back back-route="exercises.index">
        ...
        <div class="space-y-6">
            ...
            >
                ...
                <GlassCard>
                    <div class="mb-4">
                        <h3 class="font-display text-text-main text-lg font-black uppercase italic">Poids Max</h3>
                        <p class="text-text-muted text-xs font-semibold">Charge maximale par séance</p>
                    </div>
                    <div class="h-64">
                        <ExerciseMaxWeightChart :data="maxWeightData" />
                    </div>
                </GlassCard>
