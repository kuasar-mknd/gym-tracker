...
test('user can manage exercises', function (): void {
    ...
    $this->browse(function (Browser $browser) use ($user): void {
        ...
        $browser->waitForText('Nouvel exercice', 45)
            ->waitFor('input[placeholder="Ex: Développé couché"]', 45)
        ...
        // 5. Verify update
        $browser->pause(1000)
            ->waitForText('Updated Exercise', 45);
        ...
        $browser->assertDialogOpened('Supprimer cet exercice ?')
            ->acceptDialog()
            ->pause(1000)
            ->waitFor('[data-testid="create-exercise-button"]', 45)
