...
it('can list workout template sets', function () {
...
it('can list workout template sets with filter', function () {
...
it('can create a workout template set', function () {
    $data = [
        'workout_template_line_id' => $this->workoutTemplateLine->id,
        'reps' => 10,
        'weight' => 50,
...
it('can auto-increment order when creating a workout template set', function () {
...
it('cannot create a workout template set for someone else\'s workout template line', function () {
...
it('can show a workout template set', function () {
...
it('cannot show someone else\'s workout template set', function () {
    $otherUser = User::factory()->create();
    $otherTemplate = WorkoutTemplate::factory()->create([
        'user_id' => $otherUser->id,
    ]);
...
it('can update a workout template set', function () {
    $set = WorkoutTemplateSet::factory()->create([
        'workout_template_line_id' => $this->workoutTemplateLine->id,
        'reps' => 8,
        'weight' => 40,
...
it('cannot update someone else\'s workout template set', function () {
    $otherUser = User::factory()->create();
    $otherTemplate = WorkoutTemplate::factory()->create([
        'user_id' => $otherUser->id,
    ]);
...
it('can delete a workout template set', function () {
    $set = WorkoutTemplateSet::factory()->create([
        'workout_template_line_id' => $this->workoutTemplateLine->id,
    ]);
...
it('cannot delete someone else\'s workout template set', function () {
    $otherUser = User::factory()->create();
    $otherTemplate = WorkoutTemplate::factory()->create([
        'user_id' => $otherUser->id,
    ]);
